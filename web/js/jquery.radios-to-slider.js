...
(function($) {
	...
	RadiosToSlider.prototype = {
        ...
        if (radioId == 'mPassCnt_7') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_7').fadeIn('fast');
        }
        else if (radioId == 'mPassCnt_11') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_11').fadeIn('fast');
        }
        else if (radioId == 'mPassCnt_13') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_13').fadeIn('fast');
        }
        else if (radioId == 'mPassCnt_15') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_15').fadeIn('fast');
        }
        else if (radioId == 'mPassCnt_21') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_21').fadeIn('fast');
        }
        else if (radioId == 'mPassCnt_28') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_28').fadeIn('fast');
        }
			});
        ...
        if (this.id == 'mPassCnt_7') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_7').fadeIn('fast');
        }
        else if (this.id == 'mPassCnt_11') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_11').fadeIn('fast');
        }
        else if (this.id == 'mPassCnt_13') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_13').fadeIn('fast');
        }
        else if (this.id == 'mPassCnt_15') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_15').fadeIn('fast');
        }
        else if (this.id == 'mPassCnt_21') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_21').fadeIn('fast');
        }
        else if (this.id == 'mPassCnt_28') {
          $('.p_basic .priceBody').hide();
          $('#mPassPrice_28').fadeIn('fast');
        }
			});
