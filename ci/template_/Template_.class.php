...
class Template_
{
	...
	var $compile_dir   = './template.cache';
	var $compile_ext   = 'php';
	var $skin          = '';
	var $notice        = false;
	var $path_digest   = false;

	var $template_dir  = /*__DIR__ . */'../application';
	var $prefilter     = '';
	var $postfilter    = '';
	var $permission    = 0777;
	var $safe_mode     = false;
    ...
    function __construct() {
        $this->template_dir = __DIR__ . '/../application';
    }
	...
	{
		/*
		$this->lang = session("tf_lang");
		if ($this->lang) $this->compile_dir = $this->compile_dir . "/" . $this->lang;
	...
	function _get_compile_path($rpath)
	{
		...
		//$compiler->lang = $this->lang;
		$compiler->rpath = $rpath;
